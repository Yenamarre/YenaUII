...
L:RegisterTranslations("frFR", function() return {
	knockback_trigger = "^GOÛTEZ",
	submerge_trigger = "^VENEZ ! Ô MES SERVITEURS !",
...
function BigWigsRagnaros:Submerge()
	...
	if self.db.profile.emerge then
		...
		self:ScheduleEvent("bwragnarosaekbwarn", "BigWigs_Message", 85, L["knockback_soon_message"], "Urgent")
...
function BigWigsRagnaros:Emerge()
	...
	self:ScheduleEvent("bwragnarosaekbwarn", "BigWigs_Message", 24, L["knockback_soon_message"], "Urgent")
