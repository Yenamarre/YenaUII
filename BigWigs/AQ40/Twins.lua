...
L:RegisterTranslations("frFR", function() return {
	...
	bug_desc = "Préviens de l'explosion des insectes.",

	teleport_name = "Alerte Téléportation",
	teleport_desc = "Préviens des téléportations.",

	enrage_name =  "Alerte Enragés",
	enrage_desc = "Préviens quand les jumeaux sont enragés.",

	heal_name = "Alerte soins",
	heal_desc = "Préviens quand les jumeaux se soignent.",

	portwarn = "Téléportation !",
	portdelaywarn = "Téléportation dans ~5 secondes !",
	portdelaywarn2 = "Téléportation dans ~10 secondes !",
	bartext = "Téléportation",
	explodebugwarn = "Explosion d'insecte proche !",
	enragewarn = "Les jumeaux sont enragés !",
	healwarn = "Incantation de soins !",
	startwarn = "Les empereurs jumeaux engagés ! Enragés dans 15 minutes",
	enragebartext = "Enragés",
	warn1 = "Enragés dans 10 minutes",
	warn2 = "Enragés dans 5 minutes",
	warn3 = "Enragés dans 3 minutes",
	warn4 = "Enragés dans 90 secondes",
	warn5 = "Enragés dans 60 secondes",
	warn6 = "Enragés dans 30 secondes",
	warn7 = "Enragés dans 10 secondes",

	porttrigger = "gagne Téléportation des jumeaux.",
	explodebugtrigger = "gagne Explosion de l'insecte%.$",
	enragetrigger = "devient fou furieux.",-- not sure at all
	healtrigger1 = "Soigner fr\195\168re (.+) guérit",
...
function BigWigsTwins:CHAT_MSG_SPELL_PERIODIC_CREATURE_BUFFS(msg)
	if (string.find(msg, L["explodebugtrigger"]) and self.db.profile.bug) then
		self:TriggerEvent("BigWigs_Message", L["explodebugwarn"], "Personal", true, "Long")
