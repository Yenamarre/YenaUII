...
function BigWigsSound:BigWigs_Message(text, color, noraidsay, sound, broadcastonly)
	...
	if sounds[sound] and not self.db.profile.defaultonly then PlaySoundFile(sounds[sound], "Master")
	elseif sounds[color] and not noraidsay and not sound then PlaySoundFile(sounds[color], "Master")
