...
function BigWigsGrobbulus:BigWigs_RecvSync( sync, rest, nick )
	if sync == self:GetEngageSync() and rest and rest == boss and not started then
		...
		self:TriggerEvent("BigWigs_StartBar", self, "Prochain spray", 27, "Interface\\Icons\\ability_creature_poison_06")	
...
function BigWigsGrobbulus:CHAT_MSG_RAID_BOSS_EMOTE(msg)
	if string.find(msg, "sprays slime") then
		self:TriggerEvent("BigWigs_StartBar", self, "Prochain spray", 46, "Interface\\Icons\\ability_creature_poison_06")	
	end
end
