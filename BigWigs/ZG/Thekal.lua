...
L:RegisterTranslations("frFR", function() return {
	...
	heal_desc = "Préviens en cas de soin.",

	tiger_name = "Alerte Tigres",
	tiger_desc = "Préviens de l'invocation de tigres.",

	tigers_trigger = "Grand prêtre Thekal exécute Invocation de gardiens zuliens.",
	heal_trigger = "Zélote Lor'Khan commence \195\160 lancer Soins exceptionnels.",
...
function BigWigsThekal:CHAT_MSG_COMBAT_HOSTILE_DEATH(msg)
	if msg == "Grand prêtre Thekal meurt." then
		thekaldead = thekaldead + 1
	end
	
	if thekaldead > 1 then
