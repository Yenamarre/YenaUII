...
me.parserstagethree = 
{
   ["attack"] = function()
	...
	["special"] = function()
		...
		--if (me.action.spellname == "taunt") or (me.action.spellname == "growl") then
		me.action.target = UnitName("target")
		mod.combat.taunt(me.action.target)
			
		-- 3) luciole ajout par sartas
		elseif  (me.action.spellname == "luciole") or (me.action.spellname == "Faerie Fire") or (me.action.spellname == "Faerie Fire (Feral)")then
		me.action.target = UnitName("target")
