...
klhtm.string.data["frFR"] = 
{
	...
	["spell"] =
	{
		...
		["theeyeofdiminution"] = "L'Oeil de diminution",
	...
	["gui"] = {
		...
		["title"] = {
			...
			["buttonlong"] = {
				...
				["close"] = "Les données de menace sont toujours prise en compte si vous \195\170tes en groupe ou raid",
				["min"] = "",
				["max"] = "",
				["self"] = "Montre votre menace personnelle en détails",
				["raid"] = "Montre les données de menace du raid",
				["pin"] = "Emp\195\168che le d\195\169placement de la fen\195\170tre",
				["unpin"] = "Autorise le d\195\169placement de la fen\195\170tre",
				["opt"] = "",
				["targ"] = "Positionne votre cible comme cible principale. Si vous n'avez pas de cible, le cible principale est mise à z\195\169ro. R\195\169initialise",
			...
			["stringlong"] = {
				...
				["threat"] = "La quantité de menace accumulé depuis la r\195\169initialisation de votre profil.",
	...
	["optionsgui"] = {
		...
		["tooltips"] = {
			...
			["resize"] = "Si coch\195\169, le nombre de colonnes visibles sera réduit aux nombre de joueurs g\195\169n\195\169rant de la menace.",
	...
	["print"] =
	{
		["main"] =
		{
			["startupmessage"] = "KLHThreatMeter Version |cff33ff33%s|r Revision |cff33ff33%s|r chargé. Taper |cffffff00/ktm|r pour l\'aide.",
		},
		["data"] =
		{
		...
		["boss"] = 
		{
			...
			["spellsetmob"] = "%s change le paramètre de %s du talent de %s de %s vers %s.",-- "Kenco sets the multiplier parameter of Onyxia's Knock Away ability to 0.7"
			["spellsetall"] = "%s change le paramètre de %s du talent de %s de %s \195\160 %s.",
		...
		["network"] =
		{
			...
			["threatreset"] = "Le raid aggro meter a \195\169t\195\169 r\195\169initialisé par %s.",
			["newmt"] = "La cible principale est '%s' design\195\169e par %s.",
			["mtclear"] = "La cible principale a \195\169t\195\169 r\195\169initialisé par %s.",
			...
			["knockbackvaluechange"] = "|cffffff00%s|r a mis la réduction de menace de %s |cffffff00%s|r attaque \195\160 |cffffff00%d%%|r.",
			...
			upgradenote = "Les utilisateurs d'anciennes versions du mod ont \195\169t\195\169 inform\195\169 qu'une mise à jour est disponible.",
